...
// No existe alguno de los campos obligatorios
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <br><br>
                Website:
                <input type="text" name="website" value="<?php if (isset($website)) echo $website; ?>">
                <br><br>
                Comentarios: <textarea name="comentario" rows="5" cols="40" value="<?php if (isset($comentario)) echo $comentario; ?>"></textarea>
                <br><br>
                Género:
                <input type="radio" name="genero" <?php if (isset($genero) && $genero == "mujer") echo "checked"; ?>
                       value="mujer">Mujer
                <input type="radio" name="genero"  <?php if (isset($genero) && $genero == "hombre") echo "checked"; ?>
                       value="hombre">Hombre
                <br><br>
